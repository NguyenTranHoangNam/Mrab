        ...
        return (
            ...
            <View style={styles.header}>
                ...
                <View zIndex={1}>
                    ...
                    >
                        <Image
                            source={require("../../asset/image/map-5.png")}
                ...
                >
                    ...
                    >
                        <Text style={{ textAlign: 'center', width: '80%', margin: 10, borderColor: '#757575', borderRadius: 10, color: 'white' }}>Hoàn thành chuyến đi</Text>
                    </TouchableOpacity>
                    {/* </View> */}
                </View>
